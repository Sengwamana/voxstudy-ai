  ...
  return (
    <div className="w-full max-w-2xl space-y-4 md:space-y-6">
      {history.map((item, index) => (
        <div 
            key={item.id} 
            className="bg-white border border-[#DEDBD4] rounded-xl p-4 md:p-6 mb-4 shadow-sm transition-all hover:shadow-md fade-in-up"
          ...
          <div className="flex gap-3 md:gap-4">
             ...
             <div className="flex-grow">
                 <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
                    ...
                    <span className="text-[10px] font-medium text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full border border-indigo-100 flex items-center gap-1">
